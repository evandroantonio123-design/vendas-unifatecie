...
//
// ATENÇÃO: este arquivo cobre os Grupos BASE, 01, 03, 04 e uma parte do
// Grupo 02 (cursos "para licenciados" + alguns bacharelados). O restante
// do Grupo 02 ("Tecnologia em X": Análise e Desenvolvimento de Sistemas,
// Comércio Exterior, Design de Interiores, Design Gráfico, Gastronomia,
// Gestão Ambiental/Comercial/da Produção/da Qualidade/de RH/de Segurança
// Privada/do Agronegócio/Financeira/Pública, Logística, Marketing,
// Negócios Imobiliários, Processos Gerenciais, Secretariado, Segurança
// no Trabalho/Pública, Sistemas para Internet) fica para uma próxima etapa.
